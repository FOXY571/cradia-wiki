...
* To begin learning about this wiki and the wonderful world of Cradia, visit the [main page](/Cradia_Wiki). From there, you can view the wiki's main pages, such as main characters, important places, cool topics, and much more!
...
* On the left side of the webpage (or on the bottom if you are on mobile) are other useful links that can take you to different parts of the wiki.
    * The "Main page" button will bring you back to the main page.
    * The "All pages" button will take you to a list of every page in the wiki. You can use this page to easily find other pages.
    * The "Random page" button will take you to—you guessed it—a random page. This is useful if you are interested in learning something new.
